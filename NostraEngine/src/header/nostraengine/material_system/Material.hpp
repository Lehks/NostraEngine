...
namespace NOE::NOE_MATSYS
{
	...
	public:
		...
		virtual NOU::boolean enableNormalMapping(const Texture& normalMap) = 0; // same namespace no need to fully qualify the namespace name
		virtual NOU::boolean enableParrallaxMapping(const Texture& displacementMap) = 0; // same as the line above
		...
		virtual Program getProgram() const = 0; // same namespace no need to fully qualify the name
