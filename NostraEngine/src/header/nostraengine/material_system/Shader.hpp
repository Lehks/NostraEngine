...
namespace NOE::NOE_MATSYS
{
    ...
    public:
        ...
        void setVec2(const NOU::NOU_DAT_ALG::StringView8 &name, const glm::vec2 &value) const;
        void setVec3(const NOU::NOU_DAT_ALG::StringView8 &name, const glm::vec3 &value) const;
        void setVec4(const NOU::NOU_DAT_ALG::StringView8 &name, const glm::vec4 &value) const;
        ...
        void checkCompileErrors(NOU::int32 shader, NOU::NOU_DAT_ALG::String8 type);
    };
}
