...
namespace NOE::NOE_CORE
{
	...
	private:
		/**
		\brief A window pointer for the plugin system.
		*/
		NOE::NOE_WINDOW::Window *m_window;

		/**
		\brief Variable for determine if the engine is running or not.
		*/
		NOU::int8 m_runState;
		...
		*/
		...
		/**
		\brief updates the FPS and frame time
		\param begin the begin time of the current render iteration
