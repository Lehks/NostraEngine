	...
	*/
	...
	public:
		...
		*/
		...
		\brief Returns the value of the entry with the passed value (read-only).
		*/
		NOU::boolean getBoolean(const NOU::NOU_DAT_ALG::StringView8 &qualified) const;
		...
		*/
		NOU::boolean setBoolean(const NOU::NOU_DAT_ALG::StringView8 &qualified, NOU::boolean v);
		...
		\brief Returns the value of the entry with the passed value (read-only).
		*/
		const NOU::NOU_DAT_ALG::String8& getString(const NOU::NOU_DAT_ALG::StringView8 &qualified) const;
		...
		will also store the value to the source file.
		*/
		NOU::boolean setString(const NOU::NOU_DAT_ALG::StringView8 &qualified,
		...
		\brief Returns the value of the entry with the passed value (read-only).
		*/
		NOU::int32 getInt32(const NOU::NOU_DAT_ALG::StringView8 &qualified) const;
		...
		will also store the value to the source file.
		*/
		NOU::boolean setInt32(const NOU::NOU_DAT_ALG::StringView8 &qualified, NOU::int32 v);
		...
		\brief Returns the value of the entry with the passed value (read-only).
		*/
		NOU::int64 getInt64(const NOU::NOU_DAT_ALG::StringView8 &qualified) const;
		...
		will also store the value to the source file.
		*/
		NOU::boolean setInt64(const NOU::NOU_DAT_ALG::StringView8 &qualified, NOU::int64 v);
		...
		\brief Returns the value of the entry with the passed value (read-only).
		*/
		NOU::float32 getFloat32(const NOU::NOU_DAT_ALG::StringView8 &qualified) const;
		...
		will also store the value to the source file.
		*/
		NOU::boolean setFloat32(const NOU::NOU_DAT_ALG::StringView8 &qualified, NOU::float32 v);
		...
		\brief Returns the value of the entry with the passed value (read-only).
		*/
		NOU::float64 getFloat64(const NOU::NOU_DAT_ALG::StringView8 &qualified) const;
		...
		will also store the value to the source file.
		*/
		NOU::boolean setFloat64(const NOU::NOU_DAT_ALG::StringView8 &qualified, NOU::float64 v);
		...
		\brief Returns the value of the entry with the passed value (read-only).
		*/
		void* getVoidPtr(const NOU::NOU_DAT_ALG::StringView8 &qualified) const;
		...
		will also store the value to the source file.
		*/
		NOU::boolean setVoidPtr(const NOU::NOU_DAT_ALG::StringView8 &qualified, void *v);
